...
public class PLSoundWaveView: UIView {

    private var phase: CGFloat = 0.0
    private var _amplitude: CGFloat = 0.02
    ...
    public func reset() {
        self.level = 0.02
        if self.linker == nil {
            let linker = CADisplayLink(target: self, selector: #selector(PLSoundWaveView.updateMeters))
